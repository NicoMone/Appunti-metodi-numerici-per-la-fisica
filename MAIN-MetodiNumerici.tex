...
\usepackage{titlesec}
\usepackage{multicol}
%\usepackage{subfigure} % dava problemi
\usepackage{wrapfig}
\usepackage{caption}
...
\usepackage{fancyhdr}
\usepackage{enumitem} % Per liste con indentazione
...
\begin{document}
	...
	\input{Differenze-Finite.tex}
	
	\input{Thomas-algorithm.tex}
	
	\input{Jacobi-method.tex}
	
	\input{GS-SOR-LOR.tex}
	
	\input{Alternate-Direction-Implicit.tex}
	
	\input{Gradient-methods.tex}
	
	\input{Krylov-subspace.tex}
	
	\input{Wielandt-method.tex}
	
	\input{Chebyshev-method.tex}
	
	\input{Coarse-mesh-method.tex}
	
	\input{Pade_approximants.tex}
	
	\input{integro-differenziale.tex}
