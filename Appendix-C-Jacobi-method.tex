...
\begin{teorema}[teorema sulla convergenza]
	Condizione necessaria e sufficiente al che la matrice $\mathbf H$ converga è che 
	\[\rho(\mathbf H)\ <\ 1\ \ .\]
\end{teorema}
...
\textbf{Continuare da slide 13 a correggere}
...
\section{Condizioni di convergenza}
