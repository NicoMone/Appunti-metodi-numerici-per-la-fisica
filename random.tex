...
e integrando rispetto a $y$, si ottiene
...
Il metodo funziona quindi molto bene quando l'inversa dell'integrale di $p(y)$ è disponibile in forma esplicita, oppure può essere calcolata numericamente in modo efficiente. Nelle slide si sottolinea proprio questo punto: finché l'inversa dell'integrale di $p(y)$ è numericamente accessibile, si dispone di una procedura generale per generare una distribuzione arbitraria.
...
Le slide presentano anche un'interpretazione geometrica della trasformazione inversa, che è utile per capire intuitivamente il procedimento.
...
e si osserva che la variabile uniforme $x$ viene ottenuta come valore della cumulativa associata a $y$. Invertendo questa relazione, si ha ancora
...
Se $(x_1,x_2,\dots)$ è un vettore di variabili di partenza e $(y_1,y_2,\dots)$ è il nuovo vettore di variabili, allora la relazione tra le densità è regolata dal determinante jacobiano della trasformazione. Nelle slide la formula è scritta nella forma
...
È più comodo introdurre coordinate polari nel piano $(y_1,y_2)$, cioè
...
\left|
\begin{matrix}
	\frac{\partial x_1}{\partial r} & \frac{\partial x_1}{\partial \theta}\\[4pt]
...
\[
\frac{\partial x_1}{\partial r} = -r e^{-r^2/2},
\qquad
\frac{\partial x_1}{\partial \theta}=0,
\qquad
\frac{\partial x_2}{\partial r}=0,
\qquad
\frac{\partial x_2}{\partial \theta}=\frac{1}{2\pi},
\]
...
Per passare poi da coordinate polari a coordinate cartesiane si usa il noto elemento di area

\[
dy_1\,dy_2 = r\,dr\,d\theta,
\]

cioè

\[
dr\,d\theta = \frac{1}{r}\,dy_1\,dy_2.
\]

Combinando i due passaggi, si trova che la densità di $(y_1,y_2)$ è proporzionale a
